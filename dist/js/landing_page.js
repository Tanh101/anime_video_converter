...
exploreButton.addEventListener("click", () => redirectToRegisterPage());
...
function autoSlider(){
	window.setInterval(function() {swapCards("right")}, 4000);
}
...
waitForImages();
consoleText(['AnimeChan'], 'text',['#fff', '#3498DB', 'tomato', '#F1C40F', '#2ECC71', '#2C3E50', '#AF7AC5', '#1A5276', '#EC2F07', '#07ECD7']);
autoSlider();
});
